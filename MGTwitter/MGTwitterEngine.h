...
- (NSString *)getFollowersIncludingCurrentStatus:(BOOL)flag forScreenName:(NSString*) screenName;  // statuses/followers for other user
- (NSString *)getFollowersIncludingCurrentStatus:(BOOL)flag forScreenName:(NSString*) screenName withCursor:(NSString*) cursor; // cursor support for long lists
